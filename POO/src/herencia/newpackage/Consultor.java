...
public class Consultor extends Persona{
    ...
    public Consultor(String nombre_consultora, int num_consultor, int id, String dni, String nombre, String domicilio, String apellido, String telefono) {
        super(id, dni, nombre, domicilio, apellido, telefono);
